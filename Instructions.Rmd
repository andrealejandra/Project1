...
- Push your Project1 folder up to your GitHub. It should contain index.Rmd (your finished project code), the knitted html file (index.html) and optionally, the instructions files. 

- Once it is there, go to your remote repository and go to Settings > Options and scroll down to GitHub pages. Alternately, go to 
